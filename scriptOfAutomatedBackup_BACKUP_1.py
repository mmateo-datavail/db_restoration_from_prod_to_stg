...
### commands1 | Check that the backup has been already completed, before beginning the restore process
commands = [
...
cmdGroup1 = [
  ...
  """
  curl -X POST \
--url 'https://helios.cohesity.com/v2/data-protect/protection-groups/id0/runs' \
-H 'apiKey: apiKey'\
...
execute_bash_commands(cmdGroup9, 9)
